 ...
 *
 *      2. 【dfs(2) 开始】: u=2
 *         - i=1 available. 填1. (p=[2,1], st={2,1}) -> 呼叫 dfs(3)
 *
 *         3. 【dfs(3) 开始】: u=3
 *            - i=1 used. 跳过.
 *            - i=2 used. 跳过.
 *            - i=3 available. 填3. (p=[2,1,3], st={2,1,3}) -> 呼叫 dfs(4)
 *
 *            4. 【dfs(4) 开始】: u=4 > n
 *               - !!! 打印输出 "2 1 3" !!!
 *               - return 回到 dfs(3)
 *
 *            (回到 dfs(3))
 *            - i=3 分支结束. 【回溯】st[3]=false.
 *            - 循环 i 结束. return 回到 dfs(2)
 *
 *         (回到 dfs(2))
 *         - i=1 分支结束. 【回溯】st[1]=false.
 *         - i=2 used. 跳过.
 *         - i=3 available. 填3. (p=[2,3], st={2,3}) -> 呼叫 dfs(3)
 *
 *         3. 【dfs(3) 开始】: u=3
 *            - i=1 available. 填1. (p=[2,3,1], st={2,3,1}) -> 呼叫 dfs(4)
 *
 *            4. 【dfs(4) 开始】: u=4 > n
 *               - !!! 打印输出 "2 3 1" !!!
 *               - return 回到 dfs(3)
 ...
 *         (回到 dfs(2))
 *         - i=3 分支结束. 【回溯】st[3]=false.
 *         - 循环 i 结束. return 回到 dfs(1)
 *
 *      (回到 dfs(1))
 *      - i=2 的分支跑完了.
 *      - 【回溯】st[2]=false. (2号被释放).
 *      - i=3 available. 填3. (p=[3], st={3}) -> 呼叫 dfs(2)
 * 
 *      2. 【dfs(2) 开始】: u=2
 *         - i=1 available. 填1. (p=[3,1], st={3,1}) -> 呼叫 dfs(3)
 *
 *         3. 【dfs(3) 开始】: u=3
 *            - i=1 used. 跳过.
 *            - i=2 available. 填2. (p=[3,1,2], st={3,1,2}) -> 呼叫 dfs(4)
 *            
 *            4. 【dfs(4) 开始】
 *               - !!! 打印输出 "3 1 2" !!!
 *               - return
 ...
 *         (回到 dfs(2))
 *         - 【回溯】st[1]=false.
 *         - i=2 available. 填2. (p=[3,2], st={3,2}) -> 呼叫 dfs(3)
 *
 *         3. 【dfs(3) 开始】: u=3
 *            - i=1 available. 填1. (p=[3,2,1], st={3,2,1}) -> 呼叫 dfs(4)
 *            
 *            4. 【dfs(4) 开始】
 *               - !!! 打印输出 "3 2 1" !!!
 *               - return
